...
public class MockHttpServletRequestImpl {
    ...
    public Map<String, String[]> _pathMap() { return new RequestMultiValueMap(PinnedValueSource.REQUEST_PATH_VARIABLE); }

    // TODO: In real request all maps are multivalue, here it's taking [0] from map
    public String getParameter(String name) { return getPinnedValue(PinnedValueSource.REQUEST_PARAM, name, String.class); }
    public String getHeader(String name) { return getPinnedValue(PinnedValueSource.REQUEST_HEADER, name, String.class); }
}
